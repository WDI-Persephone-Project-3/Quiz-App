...
s13 = Student.create({last_name: "Ventura", first_name: "Ace", email: "petdetective@gmail.com", password: "123", password_confirmation: "123", cohort: c2})
...
test_quiz2 = Quiz.create({test_day: Date.parse('13th Dec 2015'), instructor: i3, cohort: c2})
test_quiz2 = Quiz.create({test_day: Date.parse('14th Dec 2015'), instructor: i3, cohort: c2})
